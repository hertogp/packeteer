defmodule PacketeerTest do
  ...
  defmodule Primitives do
    import Packeteer
    pack(name: "uint_", fields: [a: uint(8)], defaults: [a: 128])
    pack(name: "sint_", fields: [a: sint(8)], defaults: [a: 127])
    pack(name: "float16_", fields: [a: float(16)], defaults: [a: 42.5])
    pack(name: "float32_", fields: [a: float(32)], defaults: [a: 42.5])
    pack(name: "float64_", fields: [a: float(64)], defaults: [a: 42.5])
    pack(name: "binary_", fields: [a: binary(8)], defaults: [a: "01234567"])
    pack(name: "bytes_", fields: [a: bytes(8)], defaults: [a: "01234567"])
    pack(name: "bits_", fields: [a: bits(16)], defaults: [a: "42"])
    pack(name: "bitstring_", fields: [a: bitstring(16)], defaults: [a: "42"])
    pack(name: "utf8_", fields: [a: utf8()], defaults: [a: 8364])
    pack(name: "utf16_", fields: [a: utf16()], defaults: [a: 8364])
    pack(name: "utf32_", fields: [a: utf32()], defaults: [a: 8364])
  end

  describe "pack primitives" do
    test "uint" do
